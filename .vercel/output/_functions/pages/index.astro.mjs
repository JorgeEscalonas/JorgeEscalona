...
const $$Portafolio = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${maybeRenderHead()}<section id="portafolio" class="py-24 min-h-screen max-w-8xl mx-auto" data-astro-cid-yhalpku5> <div class="container mx-auto px-4" data-astro-cid-yhalpku5> <h2 class="text-4xl sm:text-5xl md:text-6xl font-black text-amarillo text-center mb-6" data-astro-cid-yhalpku5>
Portafolio
</h2> <h2 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white text-center mb-8" data-astro-cid-yhalpku5>
Proyectos Destacados
</h2> <div class="space-y-16 md:space-y-20 lg:space-y-24 max-w-6xl mx-auto" data-astro-cid-yhalpku5> <!-- Proyecto 1 --> <div class="flex flex-col md:flex-row items-center gap-8" data-astro-cid-yhalpku5> <!-- Imagen --> <div class="project-card md:w-1/2 flex items-center gap-2 px-6 py-3 text-sm font-semibold text-white rounded-[50px]
                    bg-white backdrop-blur-xl border border-white/20
                    shadow-[inset_1px_1px_6px_rgba(255,255,255,0.6),inset_-2px_-2px_8px_rgba(0,0,0,0.5),0_10px_25px_rgba(0,0,0,0.4)]
                    transition-all duration-300 ease-out" data-astro-cid-yhalpku5> <div class="relative overflow-hidden rounded-lg shadow-2xl w-full" data-astro-cid-yhalpku5> <div class="glow absolute inset-0 w-full h-full pointer-events-none z-10 opacity-0 transition-opacity duration-300 mix-blend-overlay bg-gradient-to-br from-white/40 to-transparent" data-astro-cid-yhalpku5></div> <img${addAttribute(mp3.src, "src")} alt="Reproductor MP3" class="w-full h-64 md:h-80 object-cover rounded-[40px]" data-astro-cid-yhalpku5> </div> </div> <!-- Contenido --> <div class="w-full md:w-1/2" data-astro-cid-yhalpku5> <div class="p-6 rounded-lg h-full" data-astro-cid-yhalpku5> <h3 class="text-4xl font-extrabold text-amarillo mb-4" data-astro-cid-yhalpku5>
Reproductor MP3
</h3> <p class="text-gray-300 mb-6 text-2xl font-bold" data-astro-cid-yhalpku5>
Aplicación en <span class="text-yellow-400" data-astro-cid-yhalpku5>C#</span> con
<span class="text-yellow-400" data-astro-cid-yhalpku5> WinForms</span> que permite reproducir
              archivos de audio con una <span class="text-amarillo" data-astro-cid-yhalpku5>
interfaz intuitiva</span> y funciones avanzadas de <span class="text-amarillo" data-astro-cid-yhalpku5>
reproducción de música</span> con gestión de <span class="text-amarillo" data-astro-cid-yhalpku5> usuarios</span> y <span class="text-amarillo" data-astro-cid-yhalpku5>
biblioteca</span>.
</p> <div class="flex flex-wrap gap-2" data-astro-cid-yhalpku5> <span class="text-xl font-semibold text-white px-3 py-1 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 shadow-[inset_1px_1px_6px_rgba(255,255,255,0.6),inset_-2px_-2px_8px_rgba(0,0,0,0.5),0_10px_25px_rgba(0,0,0,0.3)] hover:scale-105 transition" data-astro-cid-yhalpku5> <span data-astro-cid-yhalpku5> <img${addAttribute(CsharpIcon.src, "src")} alt="Csharp" class="w-5 h-5 inline-block mr-1" data-astro-cid-yhalpku5> </span>Csharp</span> <span class="text-xl font-semibold text-white px-3 py-1 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 shadow-[inset_1px_1px_6px_rgba(255,255,255,0.6),inset_-2px_-2px_8px_rgba(0,0,0,0.5),0_10px_25px_rgba(0,0,0,0.3)] hover:scale-105 transition" data-astro-cid-yhalpku5>WinForms</span> </div> <div class="mt-6" data-astro-cid-yhalpku5> <a href="https://github.com/JorgeEscalonas/ReproductorMp3" class="inline-flex items-center text-amarillo hover:scale-105 transition font-medium" data-astro-cid-yhalpku5>
Ver proyecto
<svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-astro-cid-yhalpku5> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" data-astro-cid-yhalpku5></path> </svg> </a> </div> </div> </div> </div> <!-- Proyecto 2 --> <div class="flex flex-col md:flex-row-reverse items-center gap-8" data-astro-cid-yhalpku5> <!-- Imagen --> <div class="project-card md:w-1/2 flex items-center gap-2 px-6 py-3 text-sm font-semibold text-white rounded-[50px]
                    bg-white backdrop-blur-xl border border-white/20
                    shadow-[inset_1px_1px_6px_rgba(255,255,255,0.6),inset_-2px_-2px_8px_rgba(0,0,0,0.5),0_10px_25px_rgba(0,0,0,0.4)]
                    transition-all duration-300 ease-out" data-astro-cid-yhalpku5> <div class="relative overflow-hidden rounded-lg shadow-2xl w-full" data-astro-cid-yhalpku5> <div class="glow absolute inset-0 w-full h-full pointer-events-none z-10 opacity-0 transition-opacity duration-300 mix-blend-overlay bg-gradient-to-br from-white/40 to-transparent" data-astro-cid-yhalpku5></div> <img${addAttribute(conversor.src, "src")} alt="Conversor de Precios" class="w-full h-64 md:h-80 object-cover rounded-[40px]" data-astro-cid-yhalpku5> </div> </div> <!-- Contenido --> <div class="w-full md:w-1/2" data-astro-cid-yhalpku5> <div class="p-6 rounded-lg h-full" data-astro-cid-yhalpku5> <h3 class="text-4xl font-extrabold text-amarillo mb-4" data-astro-cid-yhalpku5>
Conversor de Precios
</h3> <p class="text-gray-300 mb-6 text-2xl font-bold" data-astro-cid-yhalpku5>
Aplicación web para la <span class="text-amarillo" data-astro-cid-yhalpku5>conversión de precios</span> de productos de <span class="text-amarillo" data-astro-cid-yhalpku5>dólares a bolívares.</span>
El sistema utiliza <span class="text-amarillo" data-astro-cid-yhalpku5>PHP</span> para el backend,
              mientras que el frontend está construido con
<span class="text-amarillo" data-astro-cid-yhalpku5> HTML, CSS y Javascipt</span>.
</p> <div class="flex flex-wrap gap-2" data-astro-cid-yhalpku5> <span class="font-semibold text-xl text-white px-3 py-1 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 shadow-[inset_1px_1px_6px_rgba(255,255,255,0.6),inset_-2px_-2px_8px_rgba(0,0,0,0.5),0_10px_25px_rgba(0,0,0,0.3)] hover:scale-105 transition" data-astro-cid-yhalpku5> <span data-astro-cid-yhalpku5> <img${addAttribute(HtmlIcon.src, "src")} alt="Html" class="w-5 h-5 inline-block mr-1" data-astro-cid-yhalpku5> </span>Html</span> <span class="font-semibold text-xl text-white px-3 py-1 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 shadow-[inset_1px_1px_6px_rgba(255,255,255,0.6),inset_-2px_-2px_8px_rgba(0,0,0,0.5),0_10px_25px_rgba(0,0,0,0.3)] hover:scale-105 transition" data-astro-cid-yhalpku5> <span data-astro-cid-yhalpku5> <img${addAttribute(CssIcon.src, "src")} alt="Css" class="w-5 h-5 inline-block mr-1" data-astro-cid-yhalpku5> </span>Css</span> <span class="font-semibold text-xl text-white px-3 py-1 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 shadow-[inset_1px_1px_6px_rgba(255,255,255,0.6),inset_-2px_-2px_8px_rgba(0,0,0,0.5),0_10px_25px_rgba(0,0,0,0.3)] hover:scale-105 transition" data-astro-cid-yhalpku5> <span data-astro-cid-yhalpku5> <img${addAttribute(PhpIcon.src, "src")} alt="PHP" class="w-7 h-7 inline-block mr-1" data-astro-cid-yhalpku5> </span>Php</span> <span class="font-semibold text-xl text-white px-3 py-1 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 shadow-[inset_1px_1px_6px_rgba(255,255,255,0.6),inset_-2px_-2px_8px_rgba(0,0,0,0.5),0_10px_25px_rgba(0,0,0,0.3)] hover:scale-105 transition" data-astro-cid-yhalpku5> <span data-astro-cid-yhalpku5> <img${addAttribute(JsIcon.src, "src")} alt="JavaScript" class="w-5 h-5 inline-block mr-1" data-astro-cid-yhalpku5> </span>JavaScript</span> </div> </div> <div class="mt-6" data-astro-cid-yhalpku5> <a href="https://github.com/JorgeEscalonas/CDG" class="inline-flex items-center text-amarillo hover:scale-105 transition font-medium" data-astro-cid-yhalpku5>
Ver proyecto
<svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-astro-cid-yhalpku5> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3" data-astro-cid-yhalpku5></path> </svg> </a> </div> </div> </div> <!-- Proyecto 3 --> <div class="flex flex-col md:flex-row items-center gap-8" data-astro-cid-yhalpku5> <!-- Imagen --> <div class="project-card md:w-1/2 flex items-center gap-2 px-6 py-3 text-sm font-semibold text-white rounded-[50px]
            bg-white backdrop-blur-xl border border-white/20
            shadow-[inset_1px_1px_6px_rgba(255,255,255,0.6),inset_-2px_-2px_8px_rgba(0,0,0,0.5),0_10px_25px_rgba(0,0,0,0.4)]
            transition-all duration-300 ease-out" data-astro-cid-yhalpku5> <div class="relative overflow-hidden rounded-lg shadow-2xl w-full" data-astro-cid-yhalpku5> <div class="glow absolute inset-0 w-full h-full pointer-events-none z-10 opacity-0 transition-opacity duration-300 mix-blend-overlay bg-gradient-to-br from-white/40 to-transparent" data-astro-cid-yhalpku5></div> <img${addAttribute(Calculadora.src, "src")} alt="Calculadora de divisas" class="w-full h-64 md:h-80 object-cover rounded-[40px]" data-astro-cid-yhalpku5> </div> </div> <!-- Contenido --> <div class="w-full md:w-1/2" data-astro-cid-yhalpku5> <div class="p-6 rounded-lg h-full" data-astro-cid-yhalpku5> <h3 class="text-4xl font-extrabold text-amarillo mb-4" data-astro-cid-yhalpku5>
Calculadora de divisas
</h3> <p class="text-gray-300 mb-6 text-2xl font-bold" data-astro-cid-yhalpku5>
Aplicación desarrollada con <span class="text-amarillo" data-astro-cid-yhalpku5>Vue</span>
que utiliza la <span class="text-amarillo" data-astro-cid-yhalpku5>API oficial de tasas de cambio</span> para convertir Bolívares a <span class="text-amarillo" data-astro-cid-yhalpku5>Dólares</span> o <span class="text-amarillo" data-astro-cid-yhalpku5>Euros</span>. Proporciona datos
              actualizados y una conversión <span class="text-amarillo" data-astro-cid-yhalpku5>rápida, precisa</span> y <span class="text-amarillo" data-astro-cid-yhalpku5>fácil de usar.</span> </p> <div class="flex flex-wrap gap-2" data-astro-cid-yhalpku5> <span class="font-semibold text-xl text-white px-3 py-1 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 shadow-[inset_1px_1px_6px_rgba(255,255,255,0.6),inset_-2px_-2px_8px_rgba(0,0,0,0.5),0_10px_25px_rgba(0,0,0,0.3)] hover:scale-105 transition" data-astro-cid-yhalpku5> <span data-astro-cid-yhalpku5> <img${addAttribute(VueIcon.src, "src")} alt="Vue" class="w-5 h-5 inline-block mr-1" data-astro-cid-yhalpku5> </span>Vue</span> </div> </div> </div> </div> <!-- Proyecto 4 --> <div class="flex flex-col md:flex-row-reverse items-center gap-8" data-astro-cid-yhalpku5> <!-- Imagen --> <div class="project-card md:w-1/2 flex items-center gap-2 px-6 py-3 text-sm font-semibold text-white rounded-[50px]
                    bg-white backdrop-blur-xl border border-white/20
                    shadow-[inset_1px_1px_6px_rgba(255,255,255,0.6),inset_-2px_-2px_8px_rgba(0,0,0,0.5),0_10px_25px_rgba(0,0,0,0.4)]
                    transition-all duration-300 ease-out" data-astro-cid-yhalpku5> <div class="relative overflow-hidden rounded-lg shadow-2xl w-full" data-astro-cid-yhalpku5> <div class="glow absolute inset-0 w-full h-full pointer-events-none z-10 opacity-0 transition-opacity duration-300 mix-blend-overlay bg-gradient-to-br from-white/40 to-transparent" data-astro-cid-yhalpku5></div> <img${addAttribute(vetClinic.src, "src")} alt="Sistema Veterinario" class="w-full h-64 md:h-80 object-cover rounded-[40px]" data-astro-cid-yhalpku5> </div> </div> <!-- Contenido --> <div class="w-full md:w-1/2" data-astro-cid-yhalpku5> <div class="p-6 rounded-lg h-full" data-astro-cid-yhalpku5> <h3 class="text-4xl font-extrabold text-amarillo mb-4" data-astro-cid-yhalpku5>
Sistema Veterinario
</h3> <p class="text-gray-300 mb-6 text-2xl font-bold" data-astro-cid-yhalpku5>
Sistema de <span class="text-amarillo" data-astro-cid-yhalpku5> gestión</span> veterinaria
              desarrollado con <span class="text-amarillo" data-astro-cid-yhalpku5>Vue</span> en el frontend
              y <span class="text-amarillo" data-astro-cid-yhalpku5>Express</span> en el backend. Permite
              administrar clientes, mascotas, citas, veterinarios, servicios, facturas
              e historias clínicas mediante una <span class="text-amarillo" data-astro-cid-yhalpku5>
interfaz intuitiva</span> y un backend <span class="text-amarillo" data-astro-cid-yhalpku5>robusto conectado a MySQL.</span> </p> <div class="flex flex-wrap gap-2" data-astro-cid-yhalpku5> <span class="font-semibold text-xl text-white px-3 py-1 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 shadow-[inset_1px_1px_6px_rgba(255,255,255,0.6),inset_-2px_-2px_8px_rgba(0,0,0,0.5),0_10px_25px_rgba(0,0,0,0.3)] hover:scale-105 transition" data-astro-cid-yhalpku5> <span data-astro-cid-yhalpku5> <img${addAttribute(VueIcon.src, "src")} alt="Vue.js" class="w-5 h-5 inline-block mr-1" data-astro-cid-yhalpku5>
Vue.js</span> </span> <span class="font-semibold text-xl text-white px-3 py-1 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 shadow-[inset_1px_1px_6px_rgba(255,255,255,0.6),inset_-2px_-2px_8px_rgba(0,0,0,0.5),0_10px_25px_rgba(0,0,0,0.3)] hover:scale-105 transition" data-astro-cid-yhalpku5> <span data-astro-cid-yhalpku5> <img${addAttribute(NodeIcon.src, "src")} alt="Node.js" class="w-5 h-5 inline-block mr-1" data-astro-cid-yhalpku5> </span>Node.js</span> <span class="font-semibold text-xl text-white px-3 py-1 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 shadow-[inset_1px_1px_6px_rgba(255,255,255,0.6),inset_-2px_-2px_8px_rgba(0,0,0,0.5),0_10px_25px_rgba(0,0,0,0.3)] hover:scale-105 transition" data-astro-cid-yhalpku5> <span data-astro-cid-yhalpku5> <img${addAttribute(MySqlIcon.src, "src")} alt="MySQL" class="w-5 h-5 inline-block mr-1" data-astro-cid-yhalpku5> </span>MySQL</span> </div> </div> </div> </div> </div>  ${renderScript($$result, "E:/Jorge/Documentos jorge/programas/Astro/JorgeEscalona/src/components/Portafolio.astro?astro&type=script&index=0&lang.ts")} </div> </section>`;
...
const $$Habilidades = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<section id="habilidades" class="py-8 md:py-12 lg:py-16 min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8"> <div class="w-full max-w-7xl mx-auto"> <div class="text-center mb-8 md:mb-12 lg:mb-16"> <h2 class="text-4xl sm:text-5xl md:text-6xl font-black text-amarillo mb-1 sm:mb-2">
Habilidades
</h2> <h3 class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white">
Tecnologías que manejo
</h3> </div> <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 lg:gap-16"> ${skills.map((s, index) => renderTemplate`<div class="text-center p-4 sm:p-6">  <div class="w-20 h-20 sm:w-22 sm:h-22 md:w-26 md:h-26 lg:w-28 lg:h-28 mx-auto mb-4 sm:mb-6 flex items-center justify-center rounded-full bg-white shadow-[inset_1px_1px_6px_rgba(255,255,255,0.6),inset_-2px_-2px_8px_rgba(0,0,0,0.5),0_10px_25px_rgba(0,0,0,0.3)]"> ${renderComponent($$result, "s.icon", s.icon, { "class": "w-10 h-10 sm:w-10 sm:h-10 md:w-14 md:h-14 lg:w-16 lg:h-16 text-azul" })} </div>  <h3 class="text-2xl sm:text-3xl md:text-5xl font-bold text-amarillo mb-2 sm:mb-3"> ${s.titulo} </h3>  <p class="text-white text-lg sm:text-lg md:text-2xl font-semibold mb-4 sm:mb-6"> ${s.descripcion} </p>  <div class="flex flex-wrap justify-center gap-2 sm:gap-3"> ${s.tecnologias.map((tech) => {
    const TechIcon = techIcons[tech];
    return renderTemplate`<span class="font-medium text-white text-xs sm:text-sm md:text-base px-2 sm:px-3 py-1.5 sm:py-2 rounded-full bg-white/10 backdrop-blur-xl border border-white/20 
                          shadow-[inset_1px_1px_6px_rgba(255,255,255,0.6),inset_-2px_-2px_8px_rgba(0,0,0,0.5),0_10px_25px_rgba(0,0,0,0.3)]
                          hover:scale-105 transition whitespace-nowrap flex items-center gap-1.5"> ${TechIcon && renderTemplate`<img${addAttribute(TechIcon.src, "src")}${addAttribute(tech, "alt")} class="w-3.5 h-3.5 sm:w-4 sm:h-4 md:w-5 md:h-5">`} <span class="text-white text-xs sm:text-sm md:text-base"> ${tech} </span> </span>`;
